...
local Tabs = {
    JJKInfinite = Window:Tab({ Title = "战斗", Icon = "infinity", Locked = false }),
    JJKLegacy = Window:Tab({ Title = "金钱", Icon = "history", Locked = false }),
    JJKArtifacts = Window:Tab({ Title = "牛逼功能", Icon = "gem", Locked = false })
}
